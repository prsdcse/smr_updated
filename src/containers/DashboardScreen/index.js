        ...
        { text: 'Cancel', onPress: () => console.log('Cancel Pressed'), style: 'cancel' },
        {
          ...
          onPress: () => {
            ...
            realm.write(() => {
              ...
              const SurveyInformationDetails = JSON.parse(JSON.stringify(realm.objects('SurveyInformation')));
              _.forEach(SurveyInformationDetails, (survey) => {
                realm.create('SurveyInformation', { surveyID: survey.surveyID, status: 'deleted' }, true);
              });
